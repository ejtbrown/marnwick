...
**Tools > GPU Test** runs a small verified inference through every supported GPU backend in isolated processes, then reports which methods work and the platform, package, device, driver, or runtime reason for each deterministic failure.
